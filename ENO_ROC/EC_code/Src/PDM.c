...
void send_configure_outputs_1_6 ()
{
    ...
    data[1] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_2_5A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 1
    data[2] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_2_5A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 2
    data[3] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_2_5A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 3
    data[4] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_2_5A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 4
    data[5] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_15A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 5
    data[6] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_15A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 6
    data[7] = 0xFF;
...
void send_configure_outputs_7_12 ()
{
    ...
    data[1] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_15A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 7
    data[2] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_15A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 8
    data[3] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_2_5A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 9
    data[4] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_15A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 10
    data[5] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_2_5A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 11
    data[6] = BUILD_OUTPUT_CONFIG(CURRENT_LIMIT_15A, FEEDBACK_CURRENT, AUTO_RESET_DISABLED, HS_DISABLED); //output 12
    data[7] = 0xFF;
